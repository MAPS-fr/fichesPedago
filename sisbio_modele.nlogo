...
to setup-globals
  ...
  set social-bio 1
  set social-ogm 0.8
  set epsilon 0.1  ;intervale de variation minimal de l'ind de Shannon signifiant la fin de simulation
...
to setup
  ...
  let proOGM (rho * count patches) / 100  ; création de ro % (parcelle OGM)
...
to-report go-stop?
  ifelse ticks > 10 [
    ifelse (meMoireSHannon - Shannon) >  epsilon
...
@#$#@#$#@
## TODO
* commencer à implémenter Shannon mais des problèmescar travail sur les couleurs et l'information est pauvre (rouge,vert).
...
<experiments>
  ...
  <experiment name="bio-conv" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="50"/>
    <metric>Shannon</metric>
    ...
    <metric>FraG</metric>
    <steppedValueSet variable="alpha" first="0" step="0.1" last="1"/>
    <steppedValueSet variable="ro" first="60" step="2" last="100"/>
    <steppedValueSet variable="seuil" first="0" step="0.1" last="1"/>
    <enumeratedValueSet variable="slide-politiquespubliques">
      <value value="0"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="bio-conv-prospective" repetitions="20" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="50"/>
    <metric>Shannon</metric>
    ...
    <metric>FraG</metric>
    <steppedValueSet variable="alpha" first="0" step="0.1" last="1"/>
    <steppedValueSet variable="ro" first="87" step="0.5" last="97"/>
    <steppedValueSet variable="seuil" first="0" step="0.2" last="1"/>
    <enumeratedValueSet variable="slide-politiquespubliques">
      <value value="0"/>
    </enumeratedValueSet>
  </experiment>
